    ...
    >
      ...
      <div className="flex items-center mt-4 w-full">
        <Input
          ...
          className="flex-1"
          inputClassName="rounded-l-md rounded-r-none border-r-0 text-sm text-black focus:outline-none focus:border-bg-blue-500"
        />
        <Button
          onClick={handleSendMessage}
          className="rounded-l-none bg-dark_theme hover:bg-dark_theme/80"
        >
          Send
        </Button>
      </div>
