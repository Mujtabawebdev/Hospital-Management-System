    ...
    <section className="bg-white px-4 py-12">
      <div className="relative mx-auto max-w-7xl overflow-hidden rounded-2xl border border-blue-200 bg-gradient-to-r from-blue-50 via-white to-blue-100 p-7 shadow-lg shadow-blue-100/70 md:p-9">
        ...
        <div className="relative flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          <div>
            <h2 className="text-2xl font-black text-[#0f1f44] md:text-3xl">Ready to transform your hospital management?</h2>
            <p className="mt-3 max-w-3xl leading-7 text-slate-600">
              Start managing patients, doctors, appointments, billing, and records from one secure platform.
            </p>
          </div>
          <div className="flex flex-col gap-3 sm:flex-row">
            <Link to="/appointment">
              <Button className="w-full gap-2 rounded-xl bg-[#2563eb] px-8 py-4 hover:bg-blue-700">
