...
const SpecialitiesCard = ({ speciality }) => {
  ...
  return (
    <Card as="section" className="w-full flex flex-col gap-y-3 items-center max-w-72 border-text_grey/40 py-3 px-3 bg-gray-300/20 transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-md text-center">
      {/* title */}
